...
4. Click **Load unpacked** and select the **`an1me-tracker` folder**.
...
[![Open an issue](.github/assets/btn-openissue.svg)](https://github.com/thomasthanos/an1me-extensions/issues/new/choose)
</details>
