...
Metadata lookups may send a series title or ID to AniList, Jikan/MyAnimeList, AniSkip, AnimeFillerList, an1me.to, and image CDNs. These lookups do not include your email, account identifier, browsing history, or a device fingerprint.
...
- Disable notifications to stop the background update checker.
